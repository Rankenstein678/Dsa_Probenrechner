...
public class ChanceLogic {
    ...
    public static double[] calculateChance(int e1, int e2, int e3, int taw, int mod) {
        ...
        final int tawMod = taw-mod; //modifizierter Talentwert

        for (int w1 = 1; w1 <= 20; w1++) {
            int t1 =tawMod; //bearbeitbarer TaW Zwischenstand
            int erg1 = tawMod < 0 ? w1 - tawMod : w1; //Falls taw<0 erhöhe Würfelergebnis um modifizierten TaW
            ...
            for (int w2 = 1; w2 <= 20; w2++) {
                ...
                int erg2 = tawMod < 0 ? w2 - tawMod : w2; //Falls taw<0 erhöhe Würfelergebnis um modifizierten TaW
                ...
                for (int w3 = 1; w3 <= 20; w3++) {
                    ...
                    int erg3 = tawMod < 0 ? w3 - tawMod : w3; //Falls taw<0 erhöhe Würfelergebnis um modifizierten TaW
        ...
        return new double[]{passed / 8000.0, tap / 8000.0};
    }
}
